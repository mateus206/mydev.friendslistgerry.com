...
<body style="word-spacing:normal;background-color:#F4F4F4;">
  <div aria-roledescription="email" style="background-color:#F4F4F4;" role="article" lang="und" dir="auto">
                          ...
                          <tbody>
                            <tr>
                              <td style="width:180px;">
                                <img alt="" src="https://static.mailjet.com/mjml-website/templates/black-friday-logo.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" title="" width="180" height="auto" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td style="width:600px;">
                                <img alt="" src="https://static.mailjet.com/mjml-website/templates/black-friday-hero.jpg" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" title="" width="600" height="auto" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="center" bgcolor="#ffffff" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#ffffff;" valign="middle">
                                <p style="display:inline-block;background:#ffffff;color:#ffffff;font-family:Times New Roman, Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;">
